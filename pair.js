...
function setupCommandHandlers(socket, number) {
  ...
  try {
    ...
    // 🖼️ Image/Logo Logic
    const defaultImg = 'https://i.ibb.co/Y7mDm9s4/cafe794f723c.jpg';
...
case 'ytmp3':
    ...
    try {
        ...
        if (lakiya.match(/(youtube\.com|youtu\.be)/)) {
            ...
            const apiUrl = `https://apis.davidcyriltech.my.id/play?query=${encodeURIComponent(lakiya)}`;
...
`;
        ...
        const listener = async (update) => {
            ...
            try {
                ...
                const apiUrl = `https://apis.davidcyriltech.my.id/play?query=zanta_ZwUbRnXLEyTzfmMh0E4osfW4&url=${encodeURIComponent(videoUrl)}&type=mp3`;
